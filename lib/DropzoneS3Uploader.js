...
var _reactS3UploaderS3upload2 = _interopRequireDefault(
  _reactS3UploaderS3upload
);
...
var DropzoneS3Uploader = (function(_React$Component) {
  ...
  function DropzoneS3Uploader(props) {
    ...
    this.handleProgress = function(progress, textState, file) {
      _this.props.onProgress &&
        _this.props.onProgress(progress, textState, file);
    ...
    this.handleFinish = function(info, file) {
      ...
      _this.setState(
        { uploadedFiles: uploadedFiles, error: null, progress: null },
        function() {
  ...
  DropzoneS3Uploader.prototype.render = function render() {
    ...
    var dropzoneProps = _props.dropzoneProps;
    ...
    if (children) {
      ...
      content = _react2["default"].createElement(
        ...
        uploadedFiles.map(function(uploadedFile) {
          ...
          return _this2.props.isImage(uploadedFile.fileUrl)
            ? _react2["default"].createElement(ImageComponent, props)
            : _react2["default"].createElement(FileComponent, props);
        }),
    ...
    return _react2["default"].createElement(
      ...
      null,
      " ",
      _react2["default"].createElement("h1", null, "Test"),
      _react2["default"].createElement(
